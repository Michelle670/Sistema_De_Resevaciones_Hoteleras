...
import goHotel.model.DAO.ConsultasEmpleado;
import goHotel.model.DAO.ConsultasEmpleado;
...
public class EmpleadoController implements ActionListener {
        ...
        private final ConsultasEmpleado consultas = new ConsultasEmpleado();
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == vista.btAgregar) {
                ...
                String rolSeleccionado = vista.cbRol.getSelectedItem().toString();
                int idRol = 0;

                if (rolSeleccionado.equals("Admin")) {
                    idRol = 1;
                } else if (rolSeleccionado.equals("Recepcion")) {
                    idRol = 2;
                } else if (rolSeleccionado.equals("Limpieza")) {
                    idRol = 3;
                }
            ...
            if (e.getSource() == vista.btBuscar) {
                ...
                for (Object[] fila : consultas.buscar(nombre)) {
                    modelo.addRow(fila);
                }
            }
